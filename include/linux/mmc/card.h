...
#define MMC_STATE_LOCKED (1<<13)			/* card is currently locked */
#endif
...
#define MMC_QUIRK_CACHE_DISABLE (1 << 14)       /* prevent cache enable */
	...
	bool issue_long_pon;
	u8 *cached_ext_csd;
/* FUJITSU LIMITED:2014-11-26 H1510110 add start */
#define MMC_WORKBUFF_SIZE	512		/* work buffer size */
	void				*work_buff;
/* FUJITSU LIMITED:2014-11-26 H1510110 add end */
	unsigned int		change_speed_uhs; /* FUJITSU LIMITED:2015-12-03 H1610017 add */
};
