...
int pft_file_permission(struct file *file, int mask, loff_t offset, loff_t length);/* FUJITSU:2014-12-08 GEN-141-SCRU-ALT MOD */
...
static inline int pft_file_permission(struct file *file, int mask, loff_t offset, loff_t length) /* FUJITSU:2014-12-08 GEN-141-SCRU-ALT MOD */
{ return 0; }
