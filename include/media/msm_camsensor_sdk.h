...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
#define FLASH_RAMP_DN_DELAY_US 10000
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
...
#ifdef FJ_CAMERA_CUSTOM // start
typedef enum{
	MSM_SENSOR_MODULE_VERSION_DEFAULT = 0,
	MSM_SENSOR_MODULE_VERSION1,
	MSM_SENSOR_MODULE_VERSION2,
	MSM_SENSOR_MODULE_VERSION3,
	MSM_SENSOR_MODULE_VERSION4,
	MSM_SENSOR_MODULE_VERSION5,
} msm_sensor_module_version_t;
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
struct msm_camera_i2c_array_read_config {
    uint16_t size;
	uint16_t slave_addr;
	uint16_t reg_addr;
	uint8_t *data;
...
struct eeprom_i2c_reg_conf{
	enum eeprom_page_number_t page_num;
	uint16_t slave_addr;
	uint32_t valid_size;
	uint32_t addr;
	uint32_t addr_t;
