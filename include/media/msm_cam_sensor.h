...
#ifdef FJ_CAMERA_CUSTOM // start
    enum msm_sensor_camera_id_t camera_type;
#endif // FJ_CAMERA_CUSTOM end
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
	...
	CFG_EEPROM_PAGE_DATA,
	CFG_EEPROM_POLL_DATA,
	CFG_EEPROM_SETUP,
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
};
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
	struct eeprom_i2c_reg_conf  i2c_reg_conf;
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
};
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    CFG_SET_AF_DEFAULT_FOCUS,
    CFG_GET_ACTUATOR_DAC_TABLE,
    CFG_SET_ACTUATOR_REGISTER,
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
};
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    uint16_t *curr_lens_pos_ptr;
    int16_t dac_correct_value;
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
struct msm_actuator_i2c_reg_settings_t {
    uint16_t reg_setting_size;
    struct reg_settings_t *reg_setting;
};
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    struct msm_actuator_i2c_reg_settings_t reg_settings;
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
};
...
struct msm_camera_i2c_array_read_config32 {
//    compat_uptr_t reg_setting;
    uint16_t size;
	uint16_t slave_addr;
	uint16_t reg_addr;
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
struct msm_actuator_i2c_reg_settings_t32 {
    uint16_t reg_setting_size;
    compat_uptr_t reg_setting;
};
#endif // FJ_CAMERA_CUSTOM end
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    struct msm_actuator_i2c_reg_settings_t32 reg_settings;
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
};
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    compat_uptr_t curr_lens_pos_ptr;
    int16_t dac_correct_value;
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
struct msm_actuator_get_info_t32 {
	uint32_t focal_length_num;
	uint32_t focal_length_den;
	uint32_t f_number_num;
	uint32_t f_number_den;
...
/* FUJITSU:2016-01-21 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
       struct msm_actuator_get_info_t32 get_info;
