 ...
 */
struct compat_qseecom_client_authentication_req {
...
#ifdef __FJSEC_TZ_CIPHER__
#define COMPAT_QSEECOM_IOCTL_CLIENT_AUTHENTICATION_REQ \
    _IOWR(QSEECOM_IOC_MAGIC, 50, struct compat_qseecom_client_authentication_req)
#endif /* __FJSEC_TZ_CIPHER__ */
