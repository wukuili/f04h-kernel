...
/* FUJITSU LIMITED:2015-04-15 H1520300 add start */
#define SMEM_OEM_V0_002_FUNC_SIZE   2048
#define SMEM_OEM_V0_009_FUNC_SIZE   128
#define SMEM_OEM_V0_015_FUNC_SIZE   256 /* FUJITSU LIMITED:2015-03-30 H1510204 add */
#define SMEM_OEM_V0_018_FUNC_SIZE   16  /* FUJITSU LIMITED:2015-06-04 H1520374 BTO add */

/* FUJITSU LIMITED:2014-10-30 H1510056 mod start */
typedef struct {
	uint32_t		smem_v0_oem_001;
	uint8_t			smem_v0_oem_002[SMEM_OEM_V0_002_FUNC_SIZE];
	uint32_t		smem_v0_oem_003;
	uint32_t		smem_v0_oem_004;
	uint32_t		smem_v0_oem_005;
	uint32_t		smem_v0_oem_006;
	uint32_t		smem_v0_oem_007;
	uint32_t		smem_v0_oem_008;
	uint8_t			smem_v0_oem_009[SMEM_OEM_V0_009_FUNC_SIZE];
	uint32_t		smem_v0_oem_010;
	uint32_t		smem_v0_oem_011;
	uint32_t		smem_v0_oem_012;
	uint32_t		smem_v0_oem_013;
	uint32_t		smem_v0_oem_014; /* FUJITSU LIMITED:2015-02-16 H1510186 add */
	uint8_t			smem_v0_oem_015[SMEM_OEM_V0_015_FUNC_SIZE]; /* FUJITSU LIMITED:2015-03-30 H1510204 add */
	uint32_t		smem_v0_oem_016; /* FUJITSU LIMITED:2015-05-21 H1520362 add */
	uint32_t		smem_v0_oem_017; /* FUJITSU LIMITED:2015-06-11 H1520378 add */
	uint8_t			smem_v0_oem_018[SMEM_OEM_V0_018_FUNC_SIZE]; /* FUJITSU LIMITED:2015-06-04 H1520374 BTO add */
} smem_vendor0_data_type;
/* FUJITSU LIMITED:2014-10-30 H1510056 mod end */

typedef enum
{
	SMEM_OEM_START_ID_V0 = 0,
	SMEM_OEM_V0_001,
	SMEM_OEM_V0_002,
	SMEM_OEM_V0_003,
	SMEM_OEM_V0_004,
	...
	SMEM_OEM_V0_012,
	SMEM_OEM_V0_013,
	SMEM_OEM_V0_014, /* FUJITSU LIMITED:2015-02-16 H1510186 add */
	SMEM_OEM_V0_015, /* FUJITSU LIMITED:2015-03-30 H1510204 add */
	SMEM_OEM_V0_016, /* FUJITSU LIMITED:2015-05-21 H1520362 add */
	SMEM_OEM_V0_017, /* FUJITSU LIMITED:2015-06-11 H1520378 add */
	SMEM_OEM_V0_018, /* FUJITSU LIMITED:2015-06-04 H1520374 BTO add */
	SMEM_OEM_LAST_ID_V0
} smem_mem_vendor0_type;

void *smem_alloc_vendor0(smem_mem_vendor0_type smem_v0_type);
/* FUJITSU LIMITED:2015-04-15 H1520300 add end */
