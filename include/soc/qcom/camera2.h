...
#ifdef FJ_CAMERA_CUSTOM // start
#define SETUP_PARAM_NUM             (6)
#define SETUP_DATA_NUM             (12)
#endif // FJ_CAMERA_CUSTOM end
...
#ifdef FJ_CAMERA_CUSTOM // start
	uint32_t setup_data_num;
	uint32_t is_custom_read_seq;
	uint32_t is_use_qcom_chksum;
/* FUJITSU:2016-03-25 FJ_CAMERA_CUSTOM start */
	struct eeprom_setup_param_t setup_param[SETUP_DATA_NUM];
/* FUJITSU:2016-03-25 FJ_CAMERA_CUSTOM end */
#endif // FJ_CAMERA_CUSTOM end
