...
#define VSS_IVOCPROC_CMD_HCE_AUDITORY_CONTROL      0x10025000
#define VSS_IVOCPROC_CMD_HCE_AUDITORY_CONF         0x10025001
#define VSS_IVOCPROC_EVT_HCE_AUDITORY_STATUS       0x10025002
struct voc_set_hce_auditory_control_cmd {
	struct apr_hdr hdr;
	uint8_t data[8];
} __packed;
...
#else
int voc_set_hce_auditory_control(const long* data,uint32_t session_id);
int voc_get_hce_auditory_control(long* data);
#endif
