...
/* FCNT LIMITED:2016-08-05 SEC_LSM_016 ADD S */
#ifdef CONFIG_SECURITY_FJSEC
				fjsec_make_page_acl("packet_mmap", (unsigned long)page_to_phys(page), PAGE_SIZE);
#endif
/* FCNT LIMITED:2016-08-05 SEC_LSM_016 ADD E */
