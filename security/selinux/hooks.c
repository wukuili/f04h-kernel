...
#ifndef CONFIG_SECURITY_FJSEC /* FUJITSU:2014-11-17 GEN-141-SCRU-ALT ADD  */

extern struct security_operations *security_ops;
#endif /* CONFIG_SECURITY_FJSEC */ /* FUJITSU:2014-11-17 GEN-141-SCRU-ALT ADD */


/* SECMARK reference count */
static atomic_t selinux_secmark_refcount = ATOMIC_INIT(0);

/* FUJITSU:2014-11-17 GEN-141-SCRU-ALT ADD S */
/* ************ CAUTION by FUJITSU ************ */
// CONFIG_SECURITY_SELINUX_DEVELOP is set by default.
// So we should disable this option for the customer release system.
/* FUJITSU:2014-11-17 GEN-141-SCRU-ALT ADD E */
...
/* FUJITSU:2014-11-17 GEN-141-SCRU-ALT MOD S */
static int selinux_file_permission(struct file *file, int mask, loff_t offset, loff_t length)
/* FUJITSU:2014-11-17 GEN-141-SCRU-ALT MOD E */
{
	struct inode *inode = file_inode(file);
	struct file_security_struct *fsec = file->f_security;
	struct inode_security_struct *isec = inode->i_security;
