...
static int cap_ptrace_request_check(long request)
{
	return 0;
}
...
#ifndef CONFIG_SECURITY_FJSEC
static int cap_file_permission(struct file *file, int mask, loff_t offset, loff_t length)
{
	return 0;
}
#endif /* CONFIG_SECURITY_FJSEC */
...
#ifndef CONFIG_SECURITY_FJSEC
static int cap_kernel_load_module(char *name, void *mod, unsigned long len)
{
	return 0;
}
#endif /* CONFIG_SECURITY_FJSEC */
