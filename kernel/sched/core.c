...
int is_task_curr(struct task_struct *p)
{
    int cpu = task_cpu(p);
    ...
    if (cpu == smp_processor_id()) {
      ...
      return cpu_curr(cpu) == p;
    }
}
/* FCNT:2016-06-16 LogImprovement ADD-E */
...
/* FCNT LIMITED:2017-02-06 H1520343 add start */
	{
		unsigned long long clock;
		clock = sched_clock();
		next->fta_in_timestamp = clock;
		prev->fta_out_timestamp = clock;
	}
/* FCNT LIMITED:2017-02-06 H1520343 add end */
...
{
/* FCNT:2016-06-16 LogImprovement MOD-S */
//	extern void fta_stackdump(void);
	// struct task_struct *g, *p;
/* FCNT:2016-06-16 LogImprovement MOD-E */
