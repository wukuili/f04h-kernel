...
/* FUJITSU LIMITED:2015-06-13 T152_DISP-03-0007 ADD start */
#ifdef CONFIG_SECURITY_FJSEC
/* FCNT LIMITED:2016-08-26 SEC_LSM_025 ADD start */
static DEFINE_MUTEX(kgsl_mmap_lock);
/* FCNT LIMITED:2016-08-26 SEC_LSM_025 ADD end */
extern void fjsec_make_page_acl(char *id ,unsigned long addr ,unsigned long size);
#endif
/* FUJITSU LIMITED:2015-06-13 T152_DISP-03-0007 ADD end */
...
/* FCNT LIMITED:2016-09-23 SEC_LSM DEL */
/* FCNT LIMITED:2016-09-23 SEC_LSM MOD S */
#ifdef CONFIG_SECURITY_FJSEC
	vma->page_acl_flg = true;
#endif
	result = remap_pfn_range(vma, vma->vm_start,
				device->memstore.physaddr >> PAGE_SHIFT,
				 vma_size, vma->vm_page_prot);
#ifdef CONFIG_SECURITY_FJSEC
	vma->page_acl_flg = false;
#endif
/* FCNT LIMITED:2016-09-23 SEC_LSM MOD E */
	if (result != 0)
...
#ifdef CONFIG_SECURITY_FJSEC
/* FCNT LIMITED:2016-08-26 SEC_LSM_025 ADD start */
			mutex_lock(&kgsl_mmap_lock);
/* FCNT LIMITED:2016-08-26 SEC_LSM_025 ADD end */
			fjsec_make_page_acl("kgsl", (unsigned long)page_to_phys(page), PAGE_SIZE);
#endif
/* FUJITSU LIMITED:2015-06-13 T152_DISP-03-0007 ADD end */
			vm_insert_page(vma, addr, page);
/* FCNT LIMITED:2016-08-26 SEC_LSM_025 ADD start */
#ifdef CONFIG_SECURITY_FJSEC
			mutex_unlock(&kgsl_mmap_lock);
#endif
/* FCNT LIMITED:2016-08-26 SEC_LSM_025 ADD end */
			addr += PAGE_SIZE;
		}
