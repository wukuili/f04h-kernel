...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0007 add start */
	if (makercmd_mode && (MDSS_INTF_HDMI == ctx->intf_type)) {
		pr_info("HDMI TEST PATTERN");
		mdp_video_write(ctx, MDSS_MDP_REG_INTF_TPG_ENABLE , 0x1);
		mdp_video_write(ctx, MDSS_MDP_REG_INTF_TPG_MAIN_CONTROL,0x04); 

		mdp_video_write(ctx, MDSS_MDP_REG_INTF_TPG_INITIAL_VALUE,0x00101010); 
	}
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0007 add end */
