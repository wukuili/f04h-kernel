...
/* FCNT LIMITED:2016-02-29 H161_5_MHL_01_0016 add start */
#include <linux/mfd/fj_det.h>
/* FCNT LIMITED:2016-02-29 H161_5_MHL_01_0016 add end */
...
#if (INCLUDE_SII6031 == 1)
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
static void   (*usb_notify_cb)(void *, int);
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
	...
	usb_ctx = motg;
	if (!usb_notify_cb)
		usb_notify_cb = mhl_notify_cb;

/* FCNT LIMITED:2016-02-29 H161_5_MHL_01_0016 add start */
	device_id = fj_det_get_device_type();
	MHL_TX_DBG_INFO("Device ID:%x\n",device_id);
	if ((device_id != FJ_DET_DEVICE_1K) && (device_id != FJ_DET_DEVICE_UNKNOWN)) {
		MHL_TX_DBG_ERR("Invalid ID:%x\n",device_id);
		usb_notify_cb(usb_ctx, 0);
		return 1;
	}
/* FCNT LIMITED:2016-02-29 H161_5_MHL_01_0016 add end */

	if( mhl_switch(true) ){
		MHL_TX_DBG_ERR("mhl_switch on failed\n");
		goto err;
	}
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add end */
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
	if(!remaining_time) {
		/* timeout happens */
		MHL_TX_DBG_ERR("timeout.\n");
		goto err;
	}
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add end */
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 mod start */
#if 0
	...
	if (dev_context->mhl_detected) {
		pr_debug("mhl driver detected mhl connection\n");
		usb_notify_cb(usb_ctx, 1);
		return 0;
	} else {
		MHL_TX_DBG_INFO("mhl disconnect.\n");
	}
err:
	mhl_switch(false);
	usb_notify_cb(usb_ctx, 0);
	return 1;
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 mod end */
}
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 del start */
/*
	otg_mhl_notify(dev_context, mhl_detected);
*/
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 del end */

/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
	if (!mhl_detected){
		MHL_TX_DBG_INFO("mhl driver detected mhl disconnect\n");
		status = mhl_switch(false);
		usb_notify_cb(usb_ctx, 0);
	}
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add end */
}
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 del end */
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
	dev_context->mhl_detected = false;
	dev_context->mhl_discovery_in_progress= false;
	dev_context->usb_ctxt = 0;
	...
	mhl_info->notify = mhl_tx_discover_mhl_device;
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
static void mhl_tx_unregister_mhl_discovery(void)
{
	if (mhl_info) {
		kfree(mhl_info);
		mhl_info = NULL;
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0013 add start */
		dev_context->rcpRcvd = false;
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0013 add end */
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0013 del start */
#if 0
		init_rcp_input_dev(dev_context);
#endif
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0013 del end */
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 del end */
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add start */
		mhl_tx_unregister_mhl_discovery();
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0003 add end */
#endif
		kfree(dev_context);
	}
