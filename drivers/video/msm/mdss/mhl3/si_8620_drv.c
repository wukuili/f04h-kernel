...
#ifdef USE_MHL_HPD_CALLBACK_API
...
/* FCNT LIMITED:2016-03-23 H161_5_MHL_01_0017 mod start */
#if 0
		mhl_tx_write_reg(hw_context, REG_MHL_DP_CTL1, 0xFE);
#else
/* FCNT LIMITED:2016-05-31 H161_5_MHL_01_0019 mod start */
#if 0
		mhl_tx_write_reg(hw_context, REG_MHL_DP_CTL1, 0x1E);
#else
		mhl_tx_write_reg(hw_context, REG_MHL_DP_CTL1, 0x00);
#endif
/* FCNT LIMITED:2016-05-31 H161_5_MHL_01_0019 mod end */
#endif
/* FCNT LIMITED:2016-03-23 H161_5_MHL_01_0017 mod end */
...
#else
	MHL_TX_DBG_INFO("%x %x\n", (int)(unsigned long)hw_context,
		(int)(unsigned long)edid_buf);
#endif
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0006 mod start */
#if 0
	mhl_tx_vbus_current_ctl(I_VBUS_PRE_DISCOVERY);
#else
	mhl_tx_vbus_current_ctl(0);
#endif
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0006 mod end */
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0012 del start */
#ifdef _ENABLE_MHL3_FEATURE_
		uint8_t msc_compat =
		    BIT_CBUS_MSC_COMPATIBILITY_CONTROL_ENABLE_XDEVCAP;
#endif
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0012 del end */
		/*
	...
	for (i = 0; i < (int)num_hev_vics; i++) {
		...
		case 0x5f: /* 3840x2160@30fps */
			MHL_TX_DBG_ERR("HEV_VIC=0x%2x\n",
				p_hev_vic[i].mhl3_hev_vic_descriptor.
				vic_cea861f);
			set_hev_vic(p_hev_vic[i].mhl3_hev_vic_descriptor.
				vic_cea861f);
