...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0013 mod start */
#if 0
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0013 mod end */
...
struct rcp_keymap_t rcpSupportTable[MHL_NUM_RCP_KEY_CODES] = {
	...
	{1, 1, 0, {KEY_RIGHT, KEY_UP},   0}, /* 0x05 */
	{1, 1, 0, {KEY_RIGHT, KEY_DOWN}, 0}, /* 0x06 */
	{1, 1, 0, {KEY_LEFT,  KEY_UP},   0}, /* 0x07 */
	{1, 1, 0, {KEY_LEFT,  KEY_DOWN}, 0}, /* 0x08 */
	...
	/* 0x20 Numeric 0 */
	{0, 0, 0, {KEY_NUMERIC_0, 0},(MHL_DEV_LD_GUI)},
	/* 0x21 Numeric 1 */
	{0, 0, 0, {KEY_NUMERIC_1, 0},(MHL_DEV_LD_GUI)},
	/* 0x22 Numeric 2 */
	{0, 0, 0, {KEY_NUMERIC_2, 0},(MHL_DEV_LD_GUI)},
	/* 0x23 Numeric 3 */
	{0, 0, 0, {KEY_NUMERIC_3, 0},(MHL_DEV_LD_GUI)},
	/* 0x24 Numeric 4 */
	{0, 0, 0, {KEY_NUMERIC_4, 0},(MHL_DEV_LD_GUI)},
	/* 0x25 Numeric 5 */
	{0, 0, 0, {KEY_NUMERIC_5, 0},(MHL_DEV_LD_GUI)},
	/* 0x26 Numeric 6 */
	{0, 0, 0, {KEY_NUMERIC_6, 0},(MHL_DEV_LD_GUI)},
	/* 0x27 Numeric 7 */
	{0, 0, 0, {KEY_NUMERIC_7, 0},(MHL_DEV_LD_GUI)},
	/* 0x28 Numeric 8 */
	{0, 0, 0, {KEY_NUMERIC_8, 0},(MHL_DEV_LD_GUI)},
	/* 0x29 Numeric 9 */
	{0, 0, 0, {KEY_NUMERIC_9, 0},(MHL_DEV_LD_GUI)},
	...
	/* 0x2C Clear */
	{0, 0, 0, {KEY_CLEAR, 0},(MHL_DEV_LD_GUI)},
	...
	/* 0x30 Channel Up */
	{0, 1, 0, {KEY_CHANNELUP, 0},0},
	/* 0x31 Channel Down */
	{0, 1, 0, {KEY_CHANNELDOWN, 0},0},
	/* 0x32 Previous Channel */
	{0, 0, 0, {KEY_UNKNOWN, 0},0},
	/* 0x33 Sound Select */
	{0, 0, 0, {KEY_SOUND, 0},0},
	...
	/* 0x41 Volume Up */
	{0, 1, 0, {KEY_VOLUMEUP, 0},0},
	/* 0x42 Volume Down */
	{0, 1, 0, {KEY_VOLUMEDOWN, 0}, 0},
	/* 0x43 Mute */
	{0, 0, 0, {KEY_MUTE, 0},0},
	/* 0x44 Play */
	{0, 0, 0, {KEY_PLAY, 0}, (MHL_DEV_LD_GUI)},
	/* 0x45 Stop */
	{0, 0, 0, {KEY_STOP, 0},(MHL_DEV_LD_GUI)},
	/* 0x46 Pause */
	{0, 0, 0, {KEY_PLAYPAUSE, 0},(MHL_DEV_LD_GUI)},
	/* 0x47 Record */
	{0, 0, 0, {KEY_RECORD, 0}, 0},
	/* 0x48 Rewind */
	{0, 1, 0, {KEY_REWIND, 0}, (MHL_DEV_LD_GUI)},
	/* 0x49 Fast Forward */
	{0, 1, 0, {KEY_FASTFORWARD, 0}, (MHL_DEV_LD_GUI)},
	/* 0x4A Eject */
	{0, 0, 0, {KEY_EJECTCD, 0}, 0},
	/* 0x4B Forward */
	{0, 1, 0, {KEY_NEXTSONG, 0},(MHL_DEV_LD_GUI)},
	/* 0x4C Backward */
	{0, 1, 0, {KEY_PREVIOUSSONG, 0},(MHL_DEV_LD_GUI)},
	...
	/* 0x71 - 0x75 F1 - F5 */
	{0, 0, 0, {KEY_F1, 0}, (MHL_DEV_LD_GUI)},
	{0, 0, 0, {KEY_F2, 0}, (MHL_DEV_LD_GUI)},
	{0, 0, 0, {KEY_F3, 0}, (MHL_DEV_LD_GUI)},
	{0, 0, 0, {KEY_F4, 0}, (MHL_DEV_LD_GUI)},
	{0, 0, 0, {KEY_F5, 0}, 0},
