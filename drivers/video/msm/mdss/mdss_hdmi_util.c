...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0010 add start */
		if(!ret)
			mode->supported = false;
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0010 add end */
	}
    
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0007 add start */
    if (makercmd_mode && id != HDMI_VFRMT_720x480p60_4_3)
        mode->supported = false;
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0007 add end */
...
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0010 del start */
#if 0
...
#endif
/* FUJITSU LIMITED:2016-01-07 H161_5_MHL_01_0010 del end */
