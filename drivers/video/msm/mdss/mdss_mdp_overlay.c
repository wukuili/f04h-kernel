...
/* FUJITSU LIMITED:2015-12-24 H161_5_DISP_07_0007 mod start */
//		if (src_w > mdata->max_pipe_width) {
		if (src_w > mdata->max_mixer_width) {
/* FUJITSU LIMITED:2015-12-24 H161_5_DISP_07_0007 mod end */
...
extern bool fj_mdss_mdp_lut_push(void);
...
/* FUJITSU LIMITED:2015-05-13 H152_2_DISP_05_0001 add start */
	if(fj_mdss_mdp_lut_push())
		fj_mdss_mdp_lut_igc_config(mfd);
...
/* FUJITSU LIMITED:2015-05-13 H152_2_DISP_05_0001 add start */
static int fj_mdss_mdp_pp_ioctl(struct msm_fb_data_type *mfd,
				void __user *argp)
{
	int ret;
	struct msmfb_mdp_pp mdp_pp;
	...
	case mdp_op_lut_cfg:
		switch (mdp_pp.data.lut_cfg_data.lut_type) {
		case mdp_lut_igc:
			ret = fj_mdss_mdp_lut_igc_config(mfd);
			break;
...
/* FUJITSU LIMITED:2016-01-20 H161_5_DISP_05_0001 add start */
	case FJ_MSMFB_MDP_PP:
		pr_debug("[GAMMA]%s:cmd=FJ_MSMFB_MDP_PP\n", __func__);
		ret = fj_mdss_mdp_pp_ioctl(mfd, argp);
		break;
