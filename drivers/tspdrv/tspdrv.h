...
#define TSPDRV_GET_AUTOTUNE                 _IO(TSPDRV_IOCTL_GROUP, 14)    /* FUJITSU LIMITED:2016-01-20 ADD */
/*
...
/* Debug non-volatile */
#define APNV_VIBE_DBG_MODE      49072
#define APNV_SIZE_VIBE_DBG_MODE     8
#define APNV_ADR_VIBE_DBG_MODE      4

/* Vmax non-volatile */
#define APNV_VIB_MAGNITUDE      49265
#define APNV_SIZE_VIB_MAGNITUDE     2
#define APNV_VIB_MAGNITUDE_LO       0
#define APNV_VIB_MAGNITUDE_HI       1

/* Vmax value range */
#define FJ_HAP_VMAX_MIN_MV		5000
#define FJ_HAP_VMAX_MAX_MV		10000
#define FJ_HAP_VMAX_DEF_MV		9000

/* AutoTune non-volatile */
...
/* AutoTune freq rang */
#define AUTO_FREQ_MIN     0x29A
#define AUTO_FREQ_MAX     0x3E8
...
enum {
	...
	DBL_VERBOSE      = 1 <<   4,
	DBL_OVERKILL     = 1 <<   5,
	DBL_MAX          = DBL_TEMP | DBL_FATAL | DBL_ERROR | DBL_WARNING | DBL_INFO | DBL_VERBOSE | DBL_OVERKILL
};
