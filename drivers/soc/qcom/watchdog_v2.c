...
/* FUJITSU LIMITED:2015-04-24 H1520343 add start */
#include <asm/cacheflush.h>
/* FUJITSU LIMITED:2015-04-24 H1520343 add end */
...
/* FUJITSU LIMITED:2015-04-24 H1520343 add start */
#define WDT_BITE_DIF    10  /* bite 10sec after barked */
/* FUJITSU LIMITED:2015-04-24 H1520343 add end */
...
/* FUJITSU:2016-03-04 LogImprovement ADD-S */
	pstore_write_summary(SMR_WDT_BARK_NOW);
/* FUJITSU:2016-03-04 LogImprovement ADD-E */
...
/* FUJITSU LIMITED:2015-04-24 H1520343 add start */
	{
		if (wdog_dd->dev) {
			...
			for_each_process(tsk) {
				printk(KERN_INFO "\n");
				printk(KERN_INFO "PID: %d, Name: %s, State: %ld%s, Cpu: %d in:%lld out:%lld\n",
					tsk->pid, tsk->comm ,tsk->state, task_curr(tsk) ? "(current)" : "",
					task_cpu(tsk), tsk->fta_in_timestamp, tsk->fta_out_timestamp);
				show_stack(tsk, NULL);
			}
...
/* FUJITSU LIMITED:2015-04-24 H1520343 mod start */
/*	__raw_writel(timeout + 3*WDT_HZ, wdog_dd->base + WDT0_BITE_TIME);*/
	__raw_writel(timeout + WDT_BITE_DIF*WDT_HZ, wdog_dd->base + WDT0_BITE_TIME);
/* FUJITSU LIMITED:2015-04-24 H1520343 mod end */
