...
/* FUJITSU LIMITED:2014-10-30 H1510058 mod start */
/*	smem_ptr = (smem_vendor0_data_type *)smem_alloc(SMEM_ID_VENDOR0, sizeof(smem_vendor0_data_type)); */
	smem_ptr = (smem_vendor0_data_type *)smem_alloc(
									SMEM_ID_VENDOR0, 
									sizeof(smem_vendor0_data_type),
									0,
									SMEM_ANY_HOST_FLAG
									);
/* FUJITSU LIMITED:2014-10-30 H1510058 mod end */
	if (smem_ptr == NULL) {
	...
	case SMEM_OEM_V0_013:
		...
		break;
/* FUJITSU LIMITED:2015-02-16 H1510186 add start */
	case SMEM_OEM_V0_014:
		ret_ptr = &(smem_ptr->smem_v0_oem_014);
		break;
/* FUJITSU LIMITED:2015-02-16 H1510186 add end */
/* FUJITSU LIMITED:2015-03-30 H1510204 add start */
	case SMEM_OEM_V0_015:
		ret_ptr = &(smem_ptr->smem_v0_oem_015[0]);
		break;
/* FUJITSU LIMITED:2015-03-30 H1510204 add end */
/* FUJITSU LIMITED:2015-05-21 H1520362 add start */
	case SMEM_OEM_V0_016:
		ret_ptr = &(smem_ptr->smem_v0_oem_016);
		break;
/* FUJITSU LIMITED:2015-05-21 H1520362 add end */
/* FUJITSU LIMITED:2015-06-11 H1520378 add start */
	case SMEM_OEM_V0_017:
		ret_ptr = &(smem_ptr->smem_v0_oem_017);
		break;
/* FUJITSU LIMITED:2015-06-11 H1520378 add end */
/* FUJITSU LIMITED:2015-06-04 H1520374 BTO add start */
	case SMEM_OEM_V0_018:
		ret_ptr = &(smem_ptr->smem_v0_oem_018[0]);
		break;
/* FUJITSU LIMITED:2015-06-04 H1520374 BTO add end */
	default:
		/* DO NOTHING */
		break;
	}
