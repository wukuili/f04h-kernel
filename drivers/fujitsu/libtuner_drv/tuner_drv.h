 ...
 ******************************************************************************/
/*----------------------------------------------------------------------------*/
// tuner_drv.h COPYRIGHT FUJITSU CONNECTED TECHNOLOGIES LIMITED 2015-2017
/*----------------------------------------------------------------------------*/
/*..+....1....+....2....+....3....+....4....+....5....+....6....+....7....+...*/
#ifndef _TUNER_DRV_H
#define _TUNER_DRV_H
...
struct _mmtuner_cntxt {
	...
	/**
	 * exclusive control to access physical layer */
	struct mutex mtx;
...
struct _tsif_cntxt {
	...
	enum _bw_cir bw;						/* active BW circuit */
...
#define DLOG
#ifdef  DLOG
#define ERROR_PRINT( fmt, arg... )  { printk(KERN_ERR  "%s: %s(%d) " fmt "\n", "mmtuner", __FUNCTION__, __LINE__, ##arg); }
#if 1
#define INFO_PRINT( fmt, arg... )   { printk(KERN_INFO "%s: " fmt "\n", "mmtuner", ##arg); }
#define DEBUG_PRINT( fmt, arg... )
#define TRACE() ERROR_PRINT()
#else
#define INFO_PRINT( fmt, arg... )   { printk(KERN_INFO "%s: " fmt "\n", "mmtuner", ##arg); }
