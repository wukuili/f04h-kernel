...
static int mmc_sdio_power_restore(struct mmc_host *host)
{
	int ret;
	u32 ocr;
	u32 ocr_avail; /* FUJITSU LIMITED:2015-01-23 H1510176 add */
	...
	/* FUJITSU LIMITED:2015-01-23 H1510176 mod start */
	if (host->ocr_avail_sdio) {
		ocr_avail = host->ocr_avail;
		host->ocr_avail = host->ocr_avail_sdio;
	}
	/* FUJITSU LIMITED:2015-01-23 H1510176 mod end */

	host->ocr = mmc_select_voltage(host, ocr & ~0x7F);
	/* FUJITSU LIMITED:2015-01-23 H1510176 add start */
	if (host->ocr_avail_sdio) {
		host->ocr_avail = ocr_avail;
	}
