...
/* FUJITSU LIMITED:2016-01-19 H16100337 del start */
#if 0
...
#endif
/* FUJITSU LIMITED:2016-01-19 H16100337 del end */

extern irqreturn_t sdhci_msm_status_irq(int irq, void *dev_id);  /* FUJITSU LIMITED:2016-01-19 H16100337 add */
...
/*			NULL, mmc_gpio_cd_irqt, */  /* FUJITSU LIMITED:2016-01-19 H16100337 del */
			NULL, sdhci_msm_status_irq, /* FUJITSU LIMITED:2016-01-19 H16100337 add */
...
/* FUJITSU LIMITED:2015-12-03 H1610016 add start */
			...
			if (ret) {
				pr_err("%s: failed irq_set_irq_wake  irq=%d ret=%d\n", __func__, irq, ret);
				return ret;
			}
		}
