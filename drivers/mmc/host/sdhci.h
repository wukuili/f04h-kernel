...
struct sdhci_ops {
	...
	unsigned int	(*get_cd)(struct sdhci_host *host); /* FUJITSU LIMITED:2016-01-19 H16100337 add */
	int	(*get_host_type)(struct sdhci_host *host); /* FUJITSU LIMITED:2015-01-23 H1510175 add */
