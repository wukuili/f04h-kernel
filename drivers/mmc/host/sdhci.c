...
#include "sdhci.h"
#include "../core/cmdlog.h"	/* FCNT LIMITED:2016-03-07 H16100340 add */
...
static void sdhci_dumpregs(struct sdhci_host *host)
{
	...
	pr_info(DRIVER_NAME ": ===========================================\n");
	mmc_cmdlog_dump(host->mmc);	/* FCNT LIMITED:2016-03-07 H16100340 add */
}
...
retry: /* FUJITSU LIMITED:2015-01-23 H1510176 add */
		switch (1 << power) {
		...
		case MMC_VDD_33_34:
			...
			break;
		default:
			/* FUJITSU LIMITED:2015-01-23 H1510176 add start */
			if ((mmc_host_get_type(host->mmc) == HOST_TYPE_SDIO) && power >= 8) {
				printk("%s sdhci_set_power %d->%d\n",mmc_hostname(host->mmc), power, power-8);
				power -= 8;
				goto retry;
			}
			/* FUJITSU LIMITED:2015-01-23 H1510176 add end */
			BUG();
		}
	}
...
static int sdhci_get_cd(struct mmc_host *mmc)
{
	...
	if (mmc_host_get_type(mmc) != HOST_TYPE_SDIO) { /* FUJITSU LIMITED:2015-01-23 H1510175 add */
...
/* FUJITSU LIMITED:2014-11-26 H1510108 del start */
#if 0
...
#endif
/* FUJITSU LIMITED:2014-11-26 H1510108 del end */
...
static int sdhci_get_host_type(struct mmc_host *mmc)
{
	struct sdhci_host *host = mmc_priv(mmc);
	int ret = 0;

	if (host->ops && host->ops->get_host_type)
		ret = host->ops->get_host_type(host);
...
static const struct mmc_host_ops sdhci_ops = {
	...
	.get_cd		= sdhci_get_cd,
	.get_ro		= sdhci_get_ro,
	.get_host_type = sdhci_get_host_type, /* FUJITSU LIMITED:2015-01-23 H1510175 add */
/*	.hw_reset	= sdhci_hw_reset,*/ /* FUJITSU LIMITED:2014-11-26 H1510108 del */
...
{
	/* FUJITSU LIMITED:2015-01-23 H1510175 add start */
	if (mmc_host_get_type(host->mmc) != HOST_TYPE_SDIO)
		return 0;
	/* FUJITSU LIMITED:2015-01-23 H1510175 add end */
...
int sdhci_add_host(struct sdhci_host *host)
{
	...
	mmc->ocr_avail_sdio = (ocr_avail << 8); /* FUJITSU LIMITED:2015-01-23 H1510176 mod */
