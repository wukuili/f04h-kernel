...
// FUJITSU:Internal-ISP add start
    int32_t (*actuator_set_af_default_focus) (struct msm_actuator_ctrl_t *, struct msm_actuator_move_params_t *);
    int32_t (*actuator_get_dac_table) (struct msm_actuator_ctrl_t *, struct msm_actuator_get_info_t *);
    int32_t (*actuator_set_register) (struct msm_actuator_ctrl_t *, struct msm_actuator_set_info_t *);
    int32_t (*actuator_i2c_write) (struct msm_actuator_ctrl_t *, uint16_t, enum msm_actuator_data_type, struct reg_settings_t *);
...
/* FCNT LIMITED:2016-03-10 [AF]:step0_move add start */
	int16_t before_dac_correct_value;
