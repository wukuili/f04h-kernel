...
#define CAMERA_LOG_TAG "msm_sensor_driver: "
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
        LOGI("%s:%d Done. Eeprom subdevice id is %d\n", __func__, __LINE__, val);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
		of_node_put(src_node);
		src_node = NULL;
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
        LOGI("%s:%d DOWN seq_type %d seq_val %d config_val %ld delay %d\n", __func__, __LINE__, pd[i].seq_type, pd[i].seq_val, pd[i].config_val, pd[i].delay);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
	}
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
        LOGI("%s:%d UP seq_type %d seq_val %d config_val %ld delay %d\n", __func__, __LINE__, pu[i].seq_type, pu[i].seq_val, pu[i].config_val, pu[i].delay);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
	}
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
	LOGI("%s:%d camera id %d slave_addr 0x%x addr_type %d sensor_id_reg_addr 0x%x sensor_id 0x%x size %d size down %d", __func__, __LINE__, slave_info->camera_id, slave_info->slave_addr, 
	    slave_info->addr_type, slave_info->sensor_id_info.sensor_id_reg_addr, slave_info->sensor_id_info.sensor_id, slave_info->power_setting_array.size, slave_info->power_setting_array.size_down);
	LOGI("%s:%d is_init_params_valid %d ", __func__, __LINE__, slave_info->is_init_params_valid);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
        LOGI("%s:%d position %d", __func__, __LINE__, slave_info->sensor_init_params.position);
		LOGI("%s:%d mount %d", __func__, __LINE__, slave_info->sensor_init_params.sensor_mount_angle);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
	}
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    LOGI("%s:%d is_probe_succeed %d", __func__, __LINE__, s_ctrl->is_probe_succeed);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    LOGI("%s:%d cci_i2c_master %d sid 0x%02x i2c_freq_mode %d", __func__, __LINE__, cci_client->cci_i2c_master, cci_client->sid, cci_client->i2c_freq_mode);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    LOGI("%s:%d sensor_name[%s] eeprom_name[%s] actuator_name[%s]\n", __func__, __LINE__, s_ctrl->sensordata->sensor_name, s_ctrl->sensordata->eeprom_name, s_ctrl->sensordata->actuator_name);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
	/*
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    LOGI("%s:%d %s probe succeeded", __func__, __LINE__, slave_info->sensor_name);
#else // FJ_CAMERA_CUSTOM
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    s_ctrl->init_sensor_state = MSM_SENSOR_PROBE_END;
...
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM start */
#ifdef FJ_CAMERA_CUSTOM // start
    s_ctrl->init_sensor_state = MSM_SENSOR_PROBE_START;
	LOGI("%s:%d s_ctrl->init_sensor_state[%d]\n",__func__, __LINE__, s_ctrl->init_sensor_state);
#endif // FJ_CAMERA_CUSTOM end
/* FUJITSU:2016-01-19 FJ_CAMERA_CUSTOM end */
