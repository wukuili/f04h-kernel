...
//#define USE_MSM_CAMERA_IO_TRACE_FUNC
#ifdef USE_MSM_CAMERA_IO_TRACE_FUNC
	#define WRITEL_RELAXED	writel_relaxed
	#define READL_RELAXED	readl_relaxed
#else
	#define WRITEL_RELAXED	writel_relaxed_no_log
	#define READL_RELAXED	readl_relaxed_no_log
#endif // USE_MSM_CAMERA_IO_TRACE_FUNC
