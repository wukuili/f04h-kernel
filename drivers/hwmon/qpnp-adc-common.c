...
static const struct qpnp_vadc_map_pt adcmap_fj_therm_threshold[] = {
	{-400,	1709},
	{-390,	1705},
	{-380,	1700},
	{-370,	1694},
...
static const struct qpnp_vadc_map_pt adcmap_fj_therm_100k_threshold[] = {
	{-300,	1720},
	{-200,	1654},
	{-100,	1551},
	{0,		1405},
...
/* FUJITSU LIMITED:2016-01-05 CHARGER add start */
int32_t qpnp_adc_scale_fj_therm(struct qpnp_vadc_chip *chip, int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	voltage = qpnp_adc_scale_ratiometric_calib(adc_code,
			adc_properties, chan_properties);

	return qpnp_adc_map_temp_voltage(
			adcmap_fj_therm_threshold,
			ARRAY_SIZE(adcmap_fj_therm_threshold),
			voltage,
			&adc_chan_result->physical);
}
EXPORT_SYMBOL(qpnp_adc_scale_fj_therm);

int32_t qpnp_adc_scale_fj_therm_100k(struct qpnp_vadc_chip *chip, int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	return qpnp_adc_map_temp_voltage(
			adcmap_fj_therm_100k_threshold,
			ARRAY_SIZE(adcmap_fj_therm_100k_threshold),
			voltage,
			&adc_chan_result->physical);
}
EXPORT_SYMBOL(qpnp_adc_scale_fj_therm_100k);

#define FJ_ADC_COMBINED_RESISTANCE   1298
int32_t qpnp_adc_scale_fj_oki_voltage(struct qpnp_vadc_chip *chip, int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	adc_calib = qpnp_adc_scale_ratiometric_calib(adc_code,
			adc_properties, chan_properties);

	in_volt = adc_calib * 1000;
	voltage = ((in_volt * 11 * (1000+FJ_ADC_COMBINED_RESISTANCE)) / FJ_ADC_COMBINED_RESISTANCE);
	adc_chan_result->physical = voltage;

	return 0;
}
EXPORT_SYMBOL(qpnp_adc_scale_fj_oki_voltage);
/* FUJITSU LIMITED:2016-01-05 CHARGER add end */
