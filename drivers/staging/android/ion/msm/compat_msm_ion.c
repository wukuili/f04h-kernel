...
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD S */
#include <linux/msm_ion_ex.h>
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD E */
...
#ifdef FIDO_SEC
/**
 * for 32bit ioctl cmd comptibility for FIDO.
 */
struct compat_ion_clone_data {
	compat_uptr_t		vaddr;
	compat_uint_t		length;
	compat_int_t		fd;
};

#define COMPAT_ION_IOC_CLONE	_IOWR(ION_IOC_MAGIC, 8, struct compat_ion_clone_data)
#endif
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD E */
...
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD S */
#ifdef FIDO_SEC
static int compat_get_ion_clone_data(
			struct compat_ion_clone_data __user *data32,
			struct ion_clone_data __user *data)
{
	compat_int_t i;
	compat_uptr_t u;
	compat_ulong_t l;
...
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD S */
#ifdef FIDO_SEC
	case COMPAT_ION_IOC_CLONE:
		return ION_IOC_CLONE;
#endif
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD E */
	default:
		return cmd;
...
/* FUJITSU:2016-07-01 GEN-141-SCRU-ALT ADD S */
	...
	case COMPAT_ION_IOC_CLONE:
	{
		...
		err = compat_get_ion_clone_data(data32, data);
		if (err)
			return err;
