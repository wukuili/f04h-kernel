			     ...
			     unsigned int flags, bool grab_handle)
{
	...
	plist_for_each_entry(heap, &dev->heaps, node) {
		...
		if (secure_allocation &&
			...
			continue;
/* FUJITSU:2015-11-09 GEN-141-SCRU-ALT ADD S */
#ifdef FIDO_SEC
		/* Do not allow arbitary heap if fido flag is specified */
		if ( flags & ION_FLAG_FIDO &&
			!ion_heap_allow_fido_allocation(heap->type))
			continue;
#endif
/* FUJITSU:2015-11-09 GEN-141-SCRU-ALT ADD E */
